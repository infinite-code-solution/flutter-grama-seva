              ...
              Padding(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: const Color(
                      0xFF162A4A,
                    ), // Dark blue shade matching image
...
class HotelCard extends StatelessWidget {
  final String name;
  final String price;
  const HotelCard({super.key, required this.name, required this.price});
  @override
  Widget build(BuildContext context) {
    return Container(
      width: 110,
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: const Icon(Icons.apartment, color: Colors.grey, size: 28),
          ),
          ...
          Row(
            children: const [
              Text('4.2', style: TextStyle(fontSize: 10, color: Colors.grey)),
